...
<c:out value = "${frre_list.post_no }" />
                        ...
                        <c:if test = "${pageMaker.prev }">
                                <a href = "/community/tip_community/list?pageNum=${pageMaker.startPage -1}&amount=${pageMaker.cri.amount}">Previous</a>
                                </c:if>

                        <!-- 번호 -->                                
                                <c:forEach var="num" begin="${pageMaker.startPage }" end="${pageMaker.endPage }">
                                <a href = "/community/tip_community/list?pageNum=${num }&amount=${pageMaker.cri.amount}">
                                ${num }</a>
                                ...
                                <a href = "/community/tip_community/list?pageNum=${pageMaker.endPage+1 }&amount=${pageMaker.cri.amount}">Next</a>
                            ...
                            <!-- 이전 -->
                                ...
                                <c:if test = "${pageMaker.cri.keyword !=null }">
                        <c:if test = "${pageMaker.prev }">
                                <a href = "/community/tip_community/list?type=${pageMaker.cri.type }&keyword=${pageMaker.cri.keyword }&pageNum=${pageMaker.startPage -1}&amount=${pageMaker.cri.amount}">Previous</a>
                                </c:if>

                        <!-- 번호 -->                                
                                <c:forEach var="num" begin="${pageMaker.startPage }" end="${pageMaker.endPage }">
                                <a href = "/community/tip_community/list?type=${pageMaker.cri.type }&keyword=${pageMaker.cri.keyword }&pageNum=${num }&amount=${pageMaker.cri.amount}">
                                ${num }</a>
                                ...
                                <a href = "/community/tip_community/list?type=${pageMaker.cri.type }&keyword=${pageMaker.cri.keyword }&pageNum=${pageMaker.endPage+1 }&amount=${pageMaker.cri.amount}">Next</a>
